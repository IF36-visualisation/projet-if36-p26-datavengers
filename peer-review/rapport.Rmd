...
speedrun <- bind_rows(speedrun1, speedrun2, speedrun3, speedrun4)

games_data <- read_csv2("../data/speedrun/games-data.csv")
genres_data <- read_csv2("../data/speedrun/genres-data.csv")
platforms_data <- read_csv("../data/speedrun/platforms-data.csv")
